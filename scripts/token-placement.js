...
export class CampaignCodexTokenPlacement {
    ...
    try {
      ...
      while (this.#currentPlacement < this.config.tokens.length - 1) {
        ...
        try {
          ...
          console.error("Campaign Codex | Error during token placement:", error);
          obj.clear();
        }
      }
      return placements;
  ...
  #createPreviews() {
    ...
    for (const prototypeToken of this.config.tokens) {
      ...
      if (tokenData.randomImg) {
        tokenData.texture.src = prototypeToken.actor.img;
      }
  ...
  #destroyPreviews() {
    try {
      ...
      console.error("Campaign Codex | Error destroying previews:", error);
    }
  }
  ...
  #requestPlacement() {
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        console.error("Campaign Codex | Error setting up placement listeners:", error);
        reject(error);
      }
    });
  }
  ...
  async #finishPlacement(event) {
    try {
      ...
      console.error("Campaign Codex | Error cleaning up placement listeners:", error);
    }
  }
  ...
  #onMovePlacement(event) {
    ...
    try {
      ...
      console.error("Campaign Codex | Error moving placement:", error);
    } finally {
  ...
  /**
   * Rotate the token preview by increments when the mouse wheel is rotated.
   * @param {Event} event  Triggering mouse event.
   */
  #onRotatePlacement(event) {
    ...
    try {
      ...
      console.error("Campaign Codex | Error rotating placement:", error);
    }
  }
